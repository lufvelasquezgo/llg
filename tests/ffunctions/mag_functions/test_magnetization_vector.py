...
def test_magnetization_vector_FM_state_x_up(num_sites):
    ...
    assert numpy.allclose(mag_functions.magnetization_vector(state), [1.0, 0.0, 0.0])
...
def test_magnetization_vector_FM_state_y_up(num_sites):
    ...
    assert numpy.allclose(mag_functions.magnetization_vector(state), [0.0, 1.0, 0.0])
...
def test_magnetization_vector_FM_state_z_up(num_sites):
    ...
    assert numpy.allclose(mag_functions.magnetization_vector(state), [0.0, 0.0, 1.0])
...
def test_magnetization_vector_AFM_state_x(num_sites):
    ...
    assert numpy.allclose(mag_functions.magnetization_vector(state), [0.0, 0.0, 0.0])
