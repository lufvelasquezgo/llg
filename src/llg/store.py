...
class StoreHDF:
    ...
    :type filename: file
    :param compress: This is an option to compress the file in which the logical size
    of a file is reduced. It allows faster transmission over a network. It serialize
    the entire file.
    :type compress: bool
    """
    ...
    def populate(self, simulation_information):
        ...
        and the results of the system evolve. It receives the
        ``simulation_information``, and it contains the information of the simulation
        file and the results of the system evolve
        """
