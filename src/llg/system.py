...
class System:
    ...
    :param geometry: It contains index, position, type, mu, anisotropy_constant,
    anisotopy_axis, and field_axis of each site. Also it contains a source, target,
    and jex.
    :type geometry: dict
    ...
    def from_dict(cls, system_dict):
        ...
        :return: Object that contains index, position, type_, mu, anisotropy_constant,
        anisotopy_axis and field_axis (geometry). Also it contains a source, target,
        and jex (neighbors). Finally it contains units, damping, gyromagnetic, and
        deltat.
        :rtype: Object
        """
    ...
    def __getattr__(self, attr):
        ...
        :param attr: It receives the attribute parameter, that contains the units, the
        damping constant, the gyromagnetic constant, and the deltat.
        """
