...
def __ask_for_temperature():
    """
    It is a function which asks for valid input according to the ``confirm()``
    function. It asks for confirmation (yes/no) about if the user want to insert
    some values for temperature.
    """
    click.secho(
